...
| **[kyc-triage-agent](https://github.com/ArslaneSempai-ui/kyc-triage-agent)** | <!--p:triage.partAutomatisee~pc0-->58 %<!--/p--> of files decided without a human and **zero** uncontrolled onboardings, on <!--p:triage.dossiers-->400<!--/p--> cases | The threshold was inert: <!--p:triage.escaladesParLaRegle-->111<!--/p--> of the escalations come from a rule that is certain, and no slider will move those. |
